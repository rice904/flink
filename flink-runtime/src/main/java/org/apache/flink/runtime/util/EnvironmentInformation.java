...
public class EnvironmentInformation {
	...
	public static class MemoryInformation {
		...
		private static long maxJvmHeapMemory;

		private static long freeHeapMemoryWithDefrag;

		public MemoryInformation(long maxJvmHeapMemory, long freeHeapMemoryWithDefrag) {
		...
		public static long getFreeHeapMemoryWithDefrag() {
			return freeHeapMemoryWithDefrag;
		}
	}

	public static MemoryInformation getMemoryInformation() {
		long a = getMaxJvmHeapMemory();
		long b = getSizeOfFreeHeapMemoryWithDefrag();
		return new MemoryInformation(a, b);
	}
}
